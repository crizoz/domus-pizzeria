...
| :--- | :--- | :--- | :--- |
| **Margherita** | Pomodoro Mutti, Mozzarella Fior di Latte, Albahaca fresca | `$9.990` | Clásica italiana |
| **Pepperoni** | Pomodoro Mutti, Mozzarella Fior di Latte, Pepperoni selecto | `$11.990` | La más pedida |
| **Napolitana** | Pomodoro Mutti, Mozzarella Fior di Latte, Orégano, Tomate fresco | `$10.990` | Receta original |
